...
public class FormatInteropTest {
    ...
    void adapterComposition() {
        kotlin.jvm.functions.Function1<String, String> upper = Format.formatter((Function<String, String>) String::toUpperCase);
        kotlin.jvm.functions.Function1<String, String> exclaim = Format.formatter((JFormatter) v -> v + "!");
